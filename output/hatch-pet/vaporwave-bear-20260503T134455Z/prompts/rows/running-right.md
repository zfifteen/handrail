Create a single horizontal sprite strip for the Codex app digital pet `vaporwave-bear` in the state `running-right`.
...
- Use a perfectly flat pure user-selected #FFFF00 chroma-key background across the whole image.
...
- Do not use #FFFF00, pure user-selected, or colors close to that chroma key in the pet, props, highlights, shadows, motion marks, dust, landing marks, or effects.
